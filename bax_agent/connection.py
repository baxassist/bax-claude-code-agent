...
восстанавливается само с нарастающей паузой. Работа над задачей при этом не прерывается:
процессы Claude Code живут отдельно, накопленный ответ уедет, когда связь вернётся.
"""
